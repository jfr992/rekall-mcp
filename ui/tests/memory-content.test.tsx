...
const COMMAND_CONTENT =
  "Ran: glab mr view 3598 --repo acme-org/cloud 2>&1 | head -60 — ERROR Failed to get merge request";
...
describe("MemoryContent command rendering", () => {
  ...
  test("mono block wraps long tokens cleanly in preview and expanded views", () => {
    const longCommand =
      "Ran: glab mr view 3598 --repo acme-org/cloud-platform-engineering 2>&1 — GET https://gitlab.com/api/v4/projects/acme-org%2Fcloud%2Fplatform%2Fengineering/merge_requests/3598 " +
      "x".repeat(500);
