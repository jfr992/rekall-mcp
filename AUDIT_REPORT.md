...
- **Found / where:** [FACT] The current Ruff format gate fails on `tests/test_publish_synthesis.py`, despite CI describing blocking gates as green (`.github/workflows/ci.yml:18-26`, `tests/test_publish_synthesis.py:1-91`).
