...
Run: `cd /Users/jfr9044/Repos/memento-mcp && uv run pytest tests/test_sparse_encoder.py -v`
...
Run: `cd /Users/jfr9044/Repos/memento-mcp && uv run pytest tests/test_hybrid_search.py -v -k "not integration"`
...
Run: `cd /Users/jfr9044/Repos/memento-mcp && uv run pytest tests/test_hybrid_search.py tests/test_sparse_encoder.py -v`
Expected: All tests PASS

- [ ] **Step 6: Run existing tests to ensure no regression**

Run: `cd /Users/jfr9044/Repos/memento-mcp && uv run pytest tests/test_core.py tests/test_memory.py -v`
Expected: All tests PASS
...
Run: `cd /Users/jfr9044/Repos/memento-mcp && uv run pytest tests/test_memory.py -v`
Expected: All tests PASS
...
Run: `cd /Users/jfr9044/Repos/memento-mcp && uv run pytest tests/test_migrate_hybrid.py -v`
Expected: All tests PASS
